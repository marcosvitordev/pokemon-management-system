    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-100 via-red-50 to-amber-50">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <header className="mb-8 overflow-hidden rounded-3xl border border-white/60 bg-white/80 shadow-xl backdrop-blur">
          <div className="flex flex-col gap-6 bg-gradient-to-r from-red-600 via-rose-600 to-orange-500 p-6 text-white md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-red-50/90 sm:text-base">
                Gerencie, explore e acompanhe os seus Pokémons cadastrados de forma
          ...
          <div className="grid gap-4 p-6 sm:grid-cols-3">
            <div className="rounded-2xl border border-red-100 bg-red-50 p-4">
              ...
              <p className="mt-1 text-2xl font-extrabold text-red-600">{pokemons.length}</p>
            </div>
            <div className="rounded-2xl border border-blue-100 bg-blue-50 p-4">
              <p className="text-sm text-blue-700">Página atual</p>
              <p className="mt-1 text-2xl font-extrabold text-blue-600">{page}</p>
            </div>
            <div className="rounded-2xl border border-amber-100 bg-amber-50 p-4">
              <p className="text-sm text-amber-700">Total de páginas</p>
              <p className="mt-1 text-2xl font-extrabold text-amber-600">{totalPages}</p>
            </div>
          </div>
        </header>
        ...
        <section className="mb-8 rounded-3xl border border-white/70 bg-white/80 p-6 shadow-lg backdrop-blur">
          <div className="mb-4">
            <h2 className="text-xl font-bold text-slate-800">Filtros de pesquisa</h2>
        ...
        {loading ? (
          <div className="rounded-3xl border border-white/70 bg-white/80 p-12 text-center shadow-lg backdrop-blur">
            ...
            <p className="text-lg font-semibold text-slate-700">A carregar a Pokédex...</p>
          ...
          <div className="rounded-3xl border border-white/70 bg-white/80 p-12 text-center shadow-lg backdrop-blur">
            ...
            <h3 className="text-2xl font-bold text-slate-800">Nenhum Pokémon encontrado</h3>
            <p className="mt-2 text-slate-500">
              Tente ajustar os filtros ou adicione um novo Pokémon à sua coleção.
            </p>
          </div>
        ) : (
          <>
            <section className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
              {pokemons.map((pokemon) => {
                ...
                return (
                  ...
                  >
                    <div className={`bg-gradient-to-r ${typeGradient} p-5 text-white`}>
                    ...
                    <div className="p-5">
                      ...
                      <div className="space-y-3 text-sm text-slate-600">
                        <div className="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3">
                          <span className="font-medium text-slate-500">Número</span>
                        ...
                        <div className="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3">
                          <span className="font-medium text-slate-500">Treinador</span>
